...
<header id="hd">
    ...
    <nav id="gnb" class="gnb_large ">
        ...
        <ul class="gnb_ul">
            <li class="gnb_li on">
                <a href="javascript:void(0)" class="btn_op menu-100" title="메인">
                ...
                <div class="gnb_oparea_wr">
                    <div class="gnb_oparea">
                        <ul>
                            ...
                            <li data-menu=""><a href="" class="gnb_2da">공지시힝</a></li>
            ...
            <li class="gnb_li">
                ...
                <div class="gnb_oparea_wr">
                    <div class="gnb_oparea">
                        <ul>
                            <li data-menu=""><a href="" class="gnb_2da  ">뱃지관리</a></li>
